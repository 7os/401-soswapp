...
<html lang="en" dir="ltr" manifest="<?php echo WHOST; ?>/site.webmanifest">
  ...
  <body>
    <?php \TymFrontiers\Helper\setup_page('401','base', true, PRJ_HEADER_HEIGHT); ?>
    <?php include PRJ_INC_HEADER; ?>
    <section id="main-content">
      <div class="view-space">
        <div class="sec-div padding -p20">
          <h1> <i class="fas fa-ban fa-2x"></i> Unauthorized request.</h1>
          ...
          <p>
            <?php if (!empty($params["message"])){
              ...
              echo "Sorry, You are not authorized to requested resource.";
            } ?>
          </p>
